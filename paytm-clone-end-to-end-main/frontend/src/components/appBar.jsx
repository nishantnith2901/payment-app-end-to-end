    ...
    return (
        <div className="shadow h-14 flex justify-between">
                ...
                <div className="flex justify-center">
                    ...
                    <div className="relative w-10 h-10 overflow-hidden hover:bg-gray-300 bg-gray-100 rounded-full dark:bg-gray-600">
